...
FPS=10
intro_screen=pygame.image.load(os.path.join("Space Blaster","intro_screen-01.jpg"))
background=pygame.image.load(os.path.join("Space Blaster","game_screen-2.png"))
target=pygame.image.load(os.path.join("Space Blaster","aestroid.png"))
...
def main():
    mixer.Channel(2).play(mixer.Sound((os.path.join("Space Blaster","game_music.wav"))),100)
    window=pygame.display.set_mode((width,height),pygame.FULLSCREEN)
        ...
        for event in pygame.event.get():
            ...
            if event.type==pygame.MOUSEBUTTONDOWN:
                ...
                if 15<=hits>0 or misses!=5:
                    mixer.Channel(0).play(mixer.Sound((os.path.join("Space Blaster","laser_sound.mp3"))))
                if hits==15 or misses==5:
                    ...
                    mixer.Channel(5).play(mixer.Sound((os.path.join("Space Blaster","retry.wav"))))
                    hits=-1
                    misses=-1
                    x=1
                    window.blit(pygame.transform.scale(background,(a,b)),(0,0))
                    pygame.display.update()
                    mixer.Channel(2).play(mixer.Sound((os.path.join("Space Blaster","game_music.wav"))))
                else:
                    pass
                if pos[0] in range(tar1.x,tar1.x+tar()[0]) and pos[-1] in range(tar1.y,tar1.y+tar()[-1]):
                    a,b=window.get_size()
                    # pygame.draw.line(window,"YELLOW",(0,0),(pos),3)
                    # pygame.draw.line(window,"YELLOW",(a,0),(pos),3)
                    ...
                    mixer.Channel(3).play(mixer.Sound((os.path.join("Space Blaster","miss.wav"))))
            ...
            if misses==5:
                ...
                while x==1:
                    ...
                    mixer.Channel(4).play(mixer.Sound((os.path.join("Space Blaster","lose.wav"))))
                ...
                while x==1:
                    mixer.Channel(2).set_volume(0.04)
                    mixer.Channel(1).play(mixer.Sound((os.path.join("Space Blaster","You_Win.mp3"))))
                    x+=1
                mixer.Channel(2).set_volume(y)
                window.blit(pygame.transform.scale(background,(a,b)),(0,0))
                font=pygame.font.SysFont("Anton-Regular",40)
